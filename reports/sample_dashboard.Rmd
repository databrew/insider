---
title: "databrew's facebook multi-page performance dashboard"
params:
  get_new_data: False
  use_fake_data: True
...
if(params$use_fake_data){
  df <- generate_fake_data(df = df)
} 
...
# Clean up names
df$name <- Hmisc::capitalize(as.character(df$name))
df$x <- NULL
...
- A daily google spreadsheet update for analysts: (url hidden)
